...
while should_continue == True:
      ...
      while is_end_of_game == 1:
            ...
            while True:
                  player_guess = input("Enter the whole word or a letter (Russian language) ")
                  ...
                  if player_guess_lettered.issubset(CurrentGame.used_letters_property):
                        ...
                        print("The input is wrong. Use the letters only (Russian language)!\n")
                        continue
      ...
      if is_end_of_game == 2 or is_end_of_game == 3:
            ...
            # 3 - player guessed the word letter by letter => win
            # 4 - tries are over => lose
            print("\nСongratulations! You win!")
            print(f"The hidden word was: {CurrentGame.generated_word}")
            print("_________________________________________________________")
